...
class MinHeap {
    ...
    heapify(index) {
        ...
        if ( leftChild < this.size && this.list[leftChild].lowerbound < this.list[index].lowerbound ) smallest = leftChild 
        else smallest = index

        if ( rightChild < this.size && this.list[rightChild].lowerbound < this.list[smallest].lowerbound ) smallest = rightChild
    ...
    decreaseKey(index, node) {
        ...
        this.list[index].lowerbound = node.lowerbound;
        ...
        while (index > 0 && this.list[this.parent(index)].lowerbound > this.list[index].lowerbound) {
            let temp = this.list[index];
